...
const data = {
  ...
  teamLeft: {
    name: script.nameL,
    imageTeam: script.imageTeamL,
    makeUp: script.makeUpL,
    teamColor1: script.teamLeftColor1,
    teamColor2: script.teamLeftColor2,
    teamColor3: script.teamLeftColor3,
  },
  teamRight: {
    name: script.nameR,
    imageTeam: script.imageTeamR,
    makeUp: script.makeUpR,
    teamColor1: script.teamRightColor1,
    teamColor2: script.teamRightColor2,
    teamColor3: script.teamRightColor3,
  },
};
...
if (data.gameName !== "Team1 vs Team2") {
  // print("Game Name: " + gameName + ", Game Date: " + gameDate.toString());
