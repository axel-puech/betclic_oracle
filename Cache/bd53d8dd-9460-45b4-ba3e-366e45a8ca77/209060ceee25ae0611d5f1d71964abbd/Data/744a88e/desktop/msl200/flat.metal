...
Output_N32=Value_N1.w;
float Output_N34=0.0;
float param_10=(*sc_set0.UserUniforms).alphaRatio;
Output_N34=param_10;
...
float4 l9_617=fast::max(param_12,float4(0.0));
float4 param_13=l9_617;
if (sc_ShaderCacheConstant_tmp!=0)
{
