...
//sampler sampler Tweak_N41SmpSC 0:23
...
//texture texture2D Tweak_N41 0:4:0:23
...
//float3x3 textureSelectedTransform 4432
//float4 textureSelectedUvMinMax 4480
//float4 textureSelectedBorderColor 4496
//float3x3 Tweak_N41Transform 4560
//float4 Tweak_N41UvMinMax 4608
//float4 Tweak_N41BorderColor 4624
//float mixRatio 4640
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N41 [[function_constant(34)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N41 [[function_constant(37)]];
...
constant bool Tweak_N41HasSwappedViews [[function_constant(40)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N41 [[function_constant(75)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N41 [[function_constant(78)]];
...
constant int Tweak_N41Layout [[function_constant(81)]];
...
int l9_6=l9_1;
int param_1=textureSelectedLayout_tmp;
int param_2=l9_6;
float2 param_3=Globals.Surface_UVCoord0;
bool param_4=(int(SC_USE_UV_TRANSFORM_textureSelected_tmp)!=0);
float3x3 param_5=(*sc_set0.UserUniforms).textureSelectedTransform;
int2 param_6=int2(SC_SOFTWARE_WRAP_MODE_U_textureSelected_tmp,SC_SOFTWARE_WRAP_MODE_V_textureSelected_tmp);
bool param_7=(int(SC_USE_UV_MIN_MAX_textureSelected_tmp)!=0);
float4 param_8=(*sc_set0.UserUniforms).textureSelectedUvMinMax;
bool param_9=(int(SC_USE_CLAMP_TO_BORDER_textureSelected_tmp)!=0);
float4 param_10=(*sc_set0.UserUniforms).textureSelectedBorderColor;
float param_11=0.0;
...
float3 l9_71=l9_70;
float3 l9_72=l9_71;
float4 l9_73=sc_set0.textureSelected.sample(sc_set0.textureSelectedSmpSC,l9_72.xy,bias(l9_66));
float4 l9_74=l9_73;
if (param_9)
{
...
int l9_81=l9_76;
int param_12=Tweak_N41Layout_tmp;
int param_13=l9_81;
float2 param_14=Globals.Surface_UVCoord0;
bool param_15=(int(SC_USE_UV_TRANSFORM_Tweak_N41_tmp)!=0);
float3x3 param_16=(*sc_set0.UserUniforms).Tweak_N41Transform;
int2 param_17=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N41_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N41_tmp);
bool param_18=(int(SC_USE_UV_MIN_MAX_Tweak_N41_tmp)!=0);
float4 param_19=(*sc_set0.UserUniforms).Tweak_N41UvMinMax;
bool param_20=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N41_tmp)!=0);
float4 param_21=(*sc_set0.UserUniforms).Tweak_N41BorderColor;
float param_22=0.0;
...
float4 l9_148=sc_set0.Tweak_N41.sample(sc_set0.Tweak_N41SmpSC,l9_147.xy,bias(l9_141));
